...
WSGI_APPLICATION = "Diamour_backend.wsgi.application"
...
PHONEPE_S2S_CALLBACK_URL = "http://127.0.0.1:8000/payment/verify"
PHONEPE_UI_REDIRECT_URL = "https://thediamour.com/success/"
# Set CORS header variable
